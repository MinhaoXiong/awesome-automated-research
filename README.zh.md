...
| 类别 | 数量 | 代表项目 |
| --- | ---: | --- |
| 端到端 AI Scientists | 9 | AI-Scientist, AutoResearchClaw, InternAgent, NeuriCo |
...
| [NeuriCo](https://github.com/ChicagoHAI/NeuriCo) | 40 | 结构化 YAML idea 输入后，自动完成文献检索、实验执行、LaTeX 写作，并把完整结果推送到 GitHub 仓库 | ![CLI][i-cli] ![Skill][i-skill] | ![Claude][cl] ![Codex][cdx] ![Gemini][gem] | 1 周内 |
...
| [MagiClaw](https://github.com/sjtu-sai-agents/MagiClaw) | 81 | 以 Feishu / Lark 为入口的科学 agent 指挥中枢，可调度专用智能体并在 EvoMaster 上引导生成新 agent | ![ChatOps][i-chatops] | ![Any][any] | 1 周内 |
...
| [PaperClaw](https://github.com/guhaohao0991/PaperClaw) | 196 | 脚手架工具，可从模板生成面向特定领域的论文阅读 agent | ![Skill][i-skill] ![OC][i-oc] | ![Any][any] | 1 个月内 |
