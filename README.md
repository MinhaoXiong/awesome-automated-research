...
| --- | ---: | --- |
| End-to-End AI Scientists | 10 | AI-Scientist, AutoResearchClaw, InternAgent, AutoSci, NeuriCo |
...
| [AutoSci](https://github.com/skyllwt/AutoSci) | 542 | Wiki-centric full-lifecycle research platform: 20+ Claude Code skills from literature ingest and ideation through experiment design/run/eval to paper writing, with structured knowledge wiki and interactive graph | ![Skill][i-skill] ![Web][i-web] | ![Claude][cl] ![Any][any] | last 1 week |
...
| [PaperClaw](https://github.com/guhaohao0991/PaperClaw) | 196 | Scaffolding tool that generates domain-specific paper-reading agents from templates | ![Skill][i-skill] ![OC][i-oc] | ![Any][any] | last 1 month |
