...
| [Lune Research](https://github.com/RetrogradeLabs/lune-mcp-server) | 3 | Searches full text from peer-reviewed computer-science papers, traces citations, extracts structured evidence, and verifies claims against verbatim quotes | ![MCP][i-mcp] | ![Agnostic][ag] | last 1 week |
